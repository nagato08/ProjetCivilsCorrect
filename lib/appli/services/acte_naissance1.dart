...
class Naissance1 extends StatefulWidget {
  const Naissance1({super.key});

  @override
  State<Naissance1> createState() => _Naissance1State();
}
enum reponse{OUI,NON}
class _Naissance1State extends State<Naissance1> {
  ...
  validationform() async {
    if (formkey.currentState!.validate()) {
      ...
      builder: (context) => SimpleDialog(
        title: Text("Prenez la peine de reverifier vos informations!! Continuez?",
